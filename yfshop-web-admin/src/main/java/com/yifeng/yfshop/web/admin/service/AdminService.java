package com.yifeng.yfshop.web.admin.service;


import com.yifeng.yfshop.common.web.service.BaseClientService;
import com.yifeng.yfshop.web.admin.service.fallback.AdminServiceFallback;
...
@FeignClient(value = "yfshop-service-admin", fallback = AdminServiceFallback.class)
